...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString *phraseSpotterModelConfigDir = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"phrase_spotter_model"];
    YSKPhraseSpotterViewController *controller = [[YSKPhraseSpotterViewController alloc] initWithModelConfigDirectory:phraseSpotterModelConfigDir];
