...
#import "YSKRecognizeButton.h"
#import "UIColor+Hex.h"
#import "UIColor+Brightness.h"

@implementation YSKRecognizeButton
...
- (void)drawRect:(CGRect)rect
{
    ...
    [[UIImage imageNamed:@"microphone_black"] drawInRect:CGRectInset(rect, 7.0f, 4.0f)];
}
